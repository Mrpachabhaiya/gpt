			...
			<footer className="footer-fourth w-full pb-6">
				...
				<div className="flex items-center gap-2 ">
					...
					<div className="relative h-16 w-16 flex items-center justify-center  rounded-full">
						...
						<div
							ref={circleRef}
							className="animated-circle w-full h-full rounded-full bg-black border-4 border-black absolute overflow-hidden shadow-[0_0_60px_20px_rgba(147,51,234,0.5)] top-0 left-0 z-90 opacity-0  "
						>
