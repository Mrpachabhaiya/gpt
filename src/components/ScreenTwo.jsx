...
const ScreenTwo = ({ onClick }) => {
  ...
  return (
    <div className="screen-two h-full overflow-hidden opacity-0 top-0 left-0  flex flex-col items-center justify-start min-h-screen p-4 bg-[#0a0a14] relative overflow-x-hidden">
      {/* Header */}
      <Fader />
      <div
        ref={headerRef}
      ...
      <div className="relative w-full max-w-md">
        ...
        <div ref={footerSectionRef}>
          <div className="footer relative mt-4">
            <button
